...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://ij675x3fvi.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.shoppingcartPut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var shoppingcartPutRequest = {
            verb: 'put'.toUpperCase(),
            path: pathComponent + uritemplate('/shoppingcart').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(shoppingcartPutRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.shoppingcartOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var shoppingcartOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/shoppingcart').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(shoppingcartOptionsRequest, authType, additionalParams, config.apiKey);
    };
